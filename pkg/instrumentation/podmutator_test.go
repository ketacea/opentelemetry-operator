...
func TestMutatePodByAnnotation(t *testing.T) {
...
func TestMutatePodByLabel(t *testing.T) {
	mutator := NewMutator(logr.Discard(), k8sClient, record.NewFakeRecorder(100))
	require.NotNil(t, mutator)
	...
	tests := []struct {
	...
	}{
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "javaagent-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "javaagent-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Java: v1alpha1.Java{
						Env: []corev1.EnvVar{
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=javaagent-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		{
			name: "javaagent injection with namespace, true",
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "javaagent-namespace-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "javaagent-namespace-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Java: v1alpha1.Java{
						Env: []corev1.EnvVar{
			...
			pod: corev1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
						annotationInjectJava: "javaagent-namespace-label.example-inst",
					},
				},
				Spec: corev1.PodSpec{
					Containers: []corev1.Container{
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=javaagent-namespace-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "javaagent-multiple-containers-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "javaagent-multiple-containers-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Java: v1alpha1.Java{
						Env: []corev1.EnvVar{
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app1,k8s.namespace.name=javaagent-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app2,k8s.namespace.name=javaagent-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "javaagent-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "javaagent-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Java: v1alpha1.Java{
						Env: []corev1.EnvVar{
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=nodejs-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "nodejs-multiple-containers-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "nodejs-multiple-containers-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					NodeJS: v1alpha1.NodeJS{
						Image: "otel/nodejs:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app1,k8s.namespace.name=nodejs-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app2,k8s.namespace.name=nodejs-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "nodejs-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "nodejs-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					NodeJS: v1alpha1.NodeJS{
						Image: "otel/nodejs:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=python-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "python-multiple-containers-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "python-multiple-containers-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Python: v1alpha1.Python{
						Image: "otel/python:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app1,k8s.namespace.name=python-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app2,k8s.namespace.name=python-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "python-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "python-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Python: v1alpha1.Python{
						Image: "otel/python:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=dotnet-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		{
			name: "dotnet injection, by namespace labels",
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "dotnet-by-namespace-label",
					Labels: map[string]string{
						annotationInjectDotNet:  "example-inst",
						annotationDotNetRuntime: dotNetRuntimeLinuxMusl,
					},
			...
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "dotnet-by-namespace-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=dotnet-by-namespace-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "dotnet-multiple-containers-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "dotnet-multiple-containers-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app1,k8s.namespace.name=dotnet-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app2,k8s.namespace.name=dotnet-multiple-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "dotnet-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "dotnet-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=go-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
						},
					},
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "go-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "go-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Go: v1alpha1.Go{
						Image: "otel/go:1",
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "apache-httpd-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "apache-httpd-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					ApacheHttpd: v1alpha1.ApacheHttpd{
						Image: "otel/apache-httpd:1",
					...
					InitContainers: []corev1.Container{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								{
									Name:  apacheAttributesEnvVar,
									Value: "\n#Load the Otel Webserver SDK\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_common.so\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_resources.so\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_trace.so\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_otlp_recordable.so\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_exporter_ostream_span.so\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_exporter_otlp_grpc.so\n#Load the Otel ApacheModule SDK\nLoadFile /opt/opentelemetry-webserver/agent/sdk_lib/lib/libopentelemetry_webserver_sdk.so\n#Load the Apache Module. In this example for Apache 2.4\n#LoadModule otel_apache_module /opt/opentelemetry-webserver/agent/WebServerModule/Apache/libmod_apache_otel.so\n#Load the Apache Module. In this example for Apache 2.2\n#LoadModule otel_apache_module /opt/opentelemetry-webserver/agent/WebServerModule/Apache/libmod_apache_otel22.so\nLoadModule otel_apache_module /opt/opentelemetry-webserver/agent/WebServerModule/Apache/libmod_apache_otel.so\n#Attributes\nApacheModuleEnabled ON\nApacheModuleOtelExporterEndpoint http://collector:12345\nApacheModuleOtelSpanExporter otlp\nApacheModuleResolveBackends  ON\nApacheModuleServiceInstanceId <<SID-PLACEHOLDER>>\nApacheModuleServiceName app\nApacheModuleServiceNamespace apache-httpd-label\nApacheModuleTraceAsError  ON\n",
								},
								{
									Name: apacheServiceInstanceIdEnvVar,
									ValueFrom: &corev1.EnvVarSource{
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=app,k8s.namespace.name=apache-httpd-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
						},
					},
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "apache-httpd-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "apache-httpd-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					ApacheHttpd: v1alpha1.ApacheHttpd{
						Image: "otel/apache-httpd:1",
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "req-namespace-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "my-nginx-6c44bcbdd",
					Namespace: "req-namespace-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Nginx: v1alpha1.Nginx{
						Image: "otel/nginx-inj:1",
					...
					InitContainers: []corev1.Container{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								{
									Name:  nginxAttributesEnvVar,
									Value: "NginxModuleEnabled ON;\nNginxModuleOtelExporterEndpoint http://otlp-endpoint:4317;\nNginxModuleOtelMaxQueueSize 4096;\nNginxModuleOtelSpanExporter otlp;\nNginxModuleResolveBackends ON;\nNginxModuleServiceInstanceId <<SID-PLACEHOLDER>>;\nNginxModuleServiceName my-nginx-6c44bcbdd;\nNginxModuleServiceNamespace req-namespace-label;\nNginxModuleTraceAsError ON;\n",
								},
								{
									Name:  "OTEL_NGINX_I13N_SCRIPT",
									Value: nginxSdkInitContainerI13nScript,
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=nginx,k8s.namespace.name=req-namespace-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=my-nginx-6c44bcbdd",
								},
							},
						},
					},
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "nginx-disabled-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "my-nginx-6c44bcbdd",
					Namespace: "nginx-disabled-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Nginx: v1alpha1.Nginx{
						Image: "otel/nginx-inj:1",
		...
		{
			name: "label set to non existing instance",
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "non-existing-instance-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "non-existing-instance-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					Java: v1alpha1.Java{
						Image: "otel/java:1",
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-multi-containers-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-multi-containers-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=dotnet1,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=dotnet2,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=java1,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=java2,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=nodejs1,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=nodejs2,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=python1,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=python2,k8s.namespace.name=multi-instrumentation-multi-containers-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-multi-containers-cn-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-multi-containers-cn-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=dotnet1,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=dotnet2,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=java1,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=java2,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=nodejs1,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=nodejs2,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=python1,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
						...
						},
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=python2,k8s.namespace.name=multi-instrumentation-multi-containers-cn-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-multi-containers-dis-cn-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-multi-containers-dis-cn-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-multi-containers-no-cont-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-multi-containers-no-cont-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-single-container-no-cont-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-single-container-no-cont-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
					...
					Containers: []corev1.Container{
						{
							...
							Env: []corev1.EnvVar{
								...
								{
									Name:  "OTEL_RESOURCE_ATTRIBUTES",
									Value: "k8s.container.name=dotnet1,k8s.namespace.name=multi-instrumentation-single-container-no-cont-label,k8s.node.name=$(OTEL_RESOURCE_ATTRIBUTES_NODE_NAME),k8s.pod.name=$(OTEL_RESOURCE_ATTRIBUTES_POD_NAME)",
								},
							},
							VolumeMounts: []corev1.VolumeMount{
								{
		...
		},
		{
			...
			ns: corev1.Namespace{
				ObjectMeta: metav1.ObjectMeta{
					Name: "multi-instrumentation-single-container-spec-cont-label",
				},
			},
			inst: v1alpha1.Instrumentation{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "example-inst",
					Namespace: "multi-instrumentation-single-container-spec-cont-label",
				},
				Spec: v1alpha1.InstrumentationSpec{
					DotNet: v1alpha1.DotNet{
						Image: "otel/dotnet:1",
...
func TestGetInstrumentationValue(t *testing.T) {
	mutator := NewMutator(logr.Discard(), k8sClient, record.NewFakeRecorder(100))
	require.NotNil(t, mutator)
